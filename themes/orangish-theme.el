;;; orangish-theme.el --- Theme 

;; Copyright (C) 2016 , cyangekko
...
;;; Code:
 ...
 (let ((class '((class color) (min-colors 89)))
   ...
   'orangish
	...
	`(mode-line ((,class (:bold t :foreground ,var :background ,bg2))))
	`(header-line ((,class (:bold t :foreground ,var :background ,bg2))))
...
(provide-theme 'orangish)

;; Local Variables:
;; no-byte-compile: t
;; End:

;;; orangish-theme.el ends here
